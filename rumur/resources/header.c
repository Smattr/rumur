...
/* unrolled version of permutation_to_index() generated by
 * unroll-heaps-algorithm.py
 */
static size_t permutation_to_index_unrolled(const size_t *NONNULL permutation,
    size_t count) {
  ...
  switch (count) {
    ...
    case 4: {
      static const size_t index[4][4][4] = {
        [0] = {
          [1] = {
            [2] = 0,
            [3] = 11,
    ...
    case 5: {
      static const size_t index[5][5][5][5] = {
        [0] = {
          [1] = {
            [2] = {
              [3] = 0,
...
static __attribute__((unused)) size_t permutation_to_index(
  ...
  if (count >= 2 && count <= 5) {
    return permutation_to_index_unrolled(permutation, count);
  }
