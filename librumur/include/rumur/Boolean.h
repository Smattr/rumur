...
///
/// These are included for convenience, so you can assign expressions to these
/// constants if relevant. Do not compare against these expressions. If you want
/// to ask “is this expression the literal true/false?” use
