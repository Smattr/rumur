...
(assert (= high (ite
  u128_branch
    (ite
      ...
      (bvor (ite (bvugt high_size (_  bv0 64)) (bvshl ((_ zero_extend 120) ((_ extract   7   0) (bvlshr h_base (_ bv128 136)))) (_   bv0 128)) (_ bv0 128))
            (ite (bvugt high_size (_  bv1 64)) (bvshl ((_ zero_extend 120) ((_ extract  15   8) (bvlshr h_base (_ bv128 136)))) (_   bv8 128)) (_ bv0 128))
            (ite (bvugt high_size (_  bv2 64)) (bvshl ((_ zero_extend 120) ((_ extract  23  16) (bvlshr h_base (_ bv128 136)))) (_  bv16 128)) (_ bv0 128))
            (ite (bvugt high_size (_  bv3 64)) (bvshl ((_ zero_extend 120) ((_ extract  31  24) (bvlshr h_base (_ bv128 136)))) (_  bv24 128)) (_ bv0 128))
            (ite (bvugt high_size (_  bv4 64)) (bvshl ((_ zero_extend 120) ((_ extract  39  32) (bvlshr h_base (_ bv128 136)))) (_  bv32 128)) (_ bv0 128))
            (ite (bvugt high_size (_  bv5 64)) (bvshl ((_ zero_extend 120) ((_ extract  47  40) (bvlshr h_base (_ bv128 136)))) (_  bv40 128)) (_ bv0 128))
            (ite (bvugt high_size (_  bv6 64)) (bvshl ((_ zero_extend 120) ((_ extract  55  48) (bvlshr h_base (_ bv128 136)))) (_  bv48 128)) (_ bv0 128))
            (ite (bvugt high_size (_  bv7 64)) (bvshl ((_ zero_extend 120) ((_ extract  63  56) (bvlshr h_base (_ bv128 136)))) (_  bv56 128)) (_ bv0 128))
            (ite (bvugt high_size (_  bv8 64)) (bvshl ((_ zero_extend 120) ((_ extract  71  64) (bvlshr h_base (_ bv128 136)))) (_  bv64 128)) (_ bv0 128))
            (ite (bvugt high_size (_  bv9 64)) (bvshl ((_ zero_extend 120) ((_ extract  79  72) (bvlshr h_base (_ bv128 136)))) (_  bv72 128)) (_ bv0 128))
            (ite (bvugt high_size (_ bv10 64)) (bvshl ((_ zero_extend 120) ((_ extract  87  80) (bvlshr h_base (_ bv128 136)))) (_  bv80 128)) (_ bv0 128))
            (ite (bvugt high_size (_ bv11 64)) (bvshl ((_ zero_extend 120) ((_ extract  95  88) (bvlshr h_base (_ bv128 136)))) (_  bv88 128)) (_ bv0 128))
            (ite (bvugt high_size (_ bv12 64)) (bvshl ((_ zero_extend 120) ((_ extract 103  96) (bvlshr h_base (_ bv128 136)))) (_  bv96 128)) (_ bv0 128))
            (ite (bvugt high_size (_ bv13 64)) (bvshl ((_ zero_extend 120) ((_ extract 111 104) (bvlshr h_base (_ bv128 136)))) (_ bv104 128)) (_ bv0 128))
            (ite (bvugt high_size (_ bv14 64)) (bvshl ((_ zero_extend 120) ((_ extract 119 112) (bvlshr h_base (_ bv128 136)))) (_ bv112 128)) (_ bv0 128))
            (ite (bvugt high_size (_ bv15 64)) (bvshl ((_ zero_extend 120) ((_ extract 127 120) (bvlshr h_base (_ bv128 136)))) (_ bv120 128)) (_ bv0 128)))
      (_ bv0 128))
    (_ bv0 128))))
...
(assert (= and_mask3 (ite
  u128_branch
    (ite
      (not (= high_size (_ bv0 64)))
      (bvand (bvnot (_ bv0 128)) (bvnot (bvsub (bvshl (_ bv1 128) ((_ zero_extend 64) (bvsub aligned_width h_width))) (_ bv1 128))))
      (_ bv0 128))
    (_ bv0 128))))
  ...
  u128_branch
    (ite
      ...
      (bvor ((_ zero_extend 8) ((_ extract 127 0) h_base2))
            (ite (bvugt high_size (_ bv0 64)) (bvshl ((_ zero_extend 128) ((_ extract 7 0) high2)) (_ bv128 136)) (_ bv0 136)))
      h_base2)
    (_ bv0 136))))
...
(assert (= and_mask6 (ite
  u128_branch
    ...
    (ite
      (not (= high_size2 (_ bv0 64)))
      (bvand (bvnot (_ bv0 64)) (bvnot (bvsub (bvshl (_ bv1 64) (bvsub aligned_width h_width)) (_ bv1 64))))
      (_ bv0 64)))))
...
;(assert (not (and
;
;  (or (not u128_branch) (= (bvlshr (bvand h_base3 (bvsub (bvshl (_ bv1 136) ((_ zero_extend 72) (bvadd h_width h_offset))) (_ bv1 136))) ((_ zero_extend 72) h_offset))
;                           (bvand ((_ zero_extend 8) v) (bvsub (bvshl (_ bv1 136) ((_ zero_extend 72) h_width)) (_ bv1 136))))))))
;  (or u128_branch (bvugt h_width (_ bv64 64)) (= (bvlshr (bvand h_base5 (bvsub (bvshl (_ bv1 136) ((_ zero_extend 72) (bvadd h_width h_offset))) (_ bv1 136))) ((_ zero_extend 72) h_offset))
;                                                 (bvand ((_ zero_extend 8) v) (bvsub (bvshl (_ bv1 136) ((_ zero_extend 72) h_width)) (_ bv1 136)))))));)

;(assert (not (or (not u128_branch) (= ((_ extract 135 135) h_base) ((_ extract 135 135) h_base3)))))
;(assert (not (or u128_branch (= ((_ extract 135 135) h_base) ((_ extract 135 135) h_base5)))))
