...
;   uint128_t and_mask3 = u128_branch ? high_size != 0 ? (~((uint128_t)0)) & ~((((uint128_t)1) << (h_width + h_offset - sizeof(low2) * 8)) - 1) : 0 : 0;
;
...
(assert (= and_mask3 (ite
  u128_branch
    (ite
      (not (= high_size (_ bv0 64)))
      (bvand (bvnot (_ bv0 128)) (bvnot (bvsub (bvshl (_ bv1 128) ((_ zero_extend 64) (bvsub (bvadd h_width h_offset) (_ bv128 64)))) (_ bv1 128))))
      (_ bv0 128))
    (_ bv0 128))))
